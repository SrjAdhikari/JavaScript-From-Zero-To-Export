...
//? When we want to create an exact copy of an array, you can use the spread operator instead of manually looping through the array.
...
const copiedPerson = { ...person }; // 'person' is copied into 'copiedPerson'
...
const userProfile = { ...user, ...job }; // 'user' and 'job' are merged into 'userProfile'
...
// Spread the string into an object
