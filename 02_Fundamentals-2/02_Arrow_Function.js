...
//? An arrow function in JavaScript is a shorter and simpler way to write a function. It uses the => (arrow) symbol to separate the function's parameters from the function's body. Arrow functions were introduced in ES6 (ECMAScript 2015).
...
//* Single parameter:
//? If the function only has one parameter, you can remove the parentheses (). But if there are no parameters or more than one parameter, you still need the parentheses:
